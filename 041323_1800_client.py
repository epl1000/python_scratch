...
class App:
    ...
    def create_buttons(self):
        ...
        button3 = tk.Button(button_frame, text="Button 3", command=self.on_button3_click)
        button4 = tk.Button(button_frame, text="Button 4", command=self.on_button4_click)
        ...
        while True:
            try:
                ...
                if packet_vid.type == OmniCamPacketType.CAM_IMAGE_AVAIL.value:
                    ...
                    print("Image available packet not sent")
                    break
